    ...
    {open&&(
      <motion.div className="lb-overlay" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} onClick={onClose}>
        <motion.div className="lb-box" initial={{scale:.85,opacity:0}} animate={{scale:1,opacity:1}} exit={{scale:.85,opacity:0}} transition={{duration:.32,ease:[.16,1,.3,1]}} onClick={e=>e.stopPropagation()}>
          <img src="/assets/images/profile.webp" alt="Abhilash" className="lb-img"/>
        ...
        <div className="hero-grid">
          ...
          <div className="hero-left">
            ...
            <motion.h1 
              ...
              className="hero-h1"
            >
              Hi, I'm<br/><span className="hero-name-gold">Abhilash H S</span>
            </motion.h1>
            ...
            <motion.p 
              ...
              className="hero-bio"
            >
              Computer Science Engineering graduate and MERN Stack Developer passionate about building modern web applications, AI-powered solutions, and user-friendly interfaces.
            </motion.p>
            ...
            >
              {[['0','Years'],['4+','Projects'],['10+','Certs']].map(([n,l])=>(
