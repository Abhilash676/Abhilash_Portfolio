        ...
        <div className="footer-container">
            ...
            <FadeUp delay={0.05}>
              <div className="footer-brand">
                ...
                <p className="footer-brand-desc">
                 Computer Science Engineering graduate and MERN Stack Developer passionate about building modern web applications and AI-powered solutions.
                </p>
              </div>
            </FadeUp>
          ...
          >
            <p className="footer-copyright">
              © 2026 Abhilash HS · All Rights Reserved
            </p>
