...
const cards = [
  { icon: HiAcademicCap,  label:'Education', value:'B.E CSE', sub:'2022 – 2026',                color:'#C9A84C' },
  { icon: HiCommandLine,  label:'Focus',     value:'Full-Stack Web Dev',             sub:'MERN · PHP · SQLite',       color:'#7B5EA7' },
  { icon: HiBolt,         label:'Exploring', value:'AI ENGINEER',      sub:'Emerging Technologies',     color:'#E8C87A' },
