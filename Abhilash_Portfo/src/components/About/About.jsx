        ...
        >
          <div className="about-image-frame">
            ...
            <div className="about-image-container">
              ...
              <div className="about-name-tag">
                ...
                <div className="about-name-tag-name">Abhilash HS</div>
              </div>
            </div>
          ...
          <FadeUp delay={0.45}>
            <div className="about-stat-bar">
              {[['Fresher'],['4+','Projects'],['10+','Certs'],['CSE Graduate']].map(([n,l]) => (
          ...
          <FadeUp delay={0.15}>
            <div style={{ display:'flex', flexDirection:'column', gap:'0.9rem' }}>
              <p className="about-lead">
                 I am Abhilash H S, a Computer Science Engineering graduate from Government Engineering College, Hassan. I am passionate about MERN Stack Development, JavaScript, React, Node.js, and AI. I enjoy building real-world web applications and continuously improving my problem-solving and development skills.
              </p>
              <p className="about-body">
                I enjoy creating responsive, scalable, and user-friendly web applications using React, Node.js, Express.js, and MongoDB while continuously improving my software development skills.
              </p>
              <p className="about-body-sm">
                I'm continuously learning new technologies, improving my problem-solving skills, and building projects to prepare for a successful software engineering career.
              </p>A
            </div>
          </FadeUp>
